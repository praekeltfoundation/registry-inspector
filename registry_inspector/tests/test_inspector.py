...
def test_get_layer_dict():
    ...
    digest = {('a3ed95caeb02ffe68cdd9fd84406680ae93d633'
              'cb16422d00e8a7c22955b46d4'): '32', ('10fb34ebccea88897d4b57012071'
              '9b23fcbf3e556abdb79fdba6b2e0e4bad9ab'): '680'}
    
    for digest_value in digest:
        responses.add_callback(
            responses.HEAD, registry + '/v2/%s/blobs/%s' %
            (name, 'sha256:'+digest_value,), callback=layer_callback(digest_value, digest[digest_value]))

    manifest = {"fsLayers": [{"blobSum": "sha256:a3ed95caeb02ffe68cdd9fd84"
                                         "406680ae93d633cb16422d00e8a7c229"
                                         "55b46d4"},{"blobSum": "sha256:10fb34ebc"
                                         "cea88897d4b570120719b23fcbf3e556"
                                         "abdb79fdba6b2e0e4bad9ab"}]}
    ...
    assert resp == {"sha256:a3ed95caeb02ffe68cdd9fd84406680ae93d633cb16422"
                    "d00e8a7c22955b46d4": 32, "sha256:10fb34ebccea88897d4b570120719b23fcbf3e556abdb79fdba6b2e0e4bad9ab": 680}
