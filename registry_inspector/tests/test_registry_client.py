...
def test_get_manifests():
    ...
    responses.add(
      ...
      {
         "blobSum": "sha256:10fb34ebccea88897d4b570120719b23fcbf3e556abdb79fdba6b2e0e4bad9ab"
      },
      {
         "blobSum": "sha256:4c876570bd7d10c58fc291fa980404290de01bfc01410daeb57a9dd6b86fac57"
      },
      {
         "blobSum": "sha256:6874f9870f5f8b13aea44707fddf746825247dda0f3abc9d93438b58c97cdacd"
      },
      {
         "blobSum": "sha256:5ba4f30e5bea63dcc2e7054b8b4f41ab1e5fcc7db0a88fc79359b890bcfe2258"
      }
   ]})
    resp = client.get_manifests(name, tag)['fsLayers']
    assert resp == {"fsLayers": [
      {
         "blobSum": "sha256:a3ed95caeb02ffe68cdd9fd84406680ae93d633cb16422d00e8a7c22955b46d4"
      },
      {
